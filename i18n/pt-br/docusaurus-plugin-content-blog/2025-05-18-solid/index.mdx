...
<BlogImage src="/img/blog/single-responsibility.webp" alt="Exemplo de classe com responsabilidade única" />
...
<BlogImage src="/img/blog/open-closed.webp" alt="Exemplo de classe aberta para extensões" />
...
<BlogImage src="/img/blog/liskov.webp" alt="Exemplo de classe aberta para extensões" />
